...
const testimonials = [
  {
    quote: "Ultra Realty Estates made our dream home a reality. Their expertise in the luxury market is unmatched, and the personalized service we received was extraordinary.",
  ...
  {
    quote: "As an investor, I trust Ultra Realty Estates for their deep market analysis and strategic guidance. They've helped me build a portfolio worth over $30M.",
    name: "Amara Williams",
